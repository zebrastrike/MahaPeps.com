 ...
 */
export declare function shipmentsList(client: ShippoCore, request: operations.ListShipmentsRequest, options?: RequestOptions): Promise<Result<components.ShipmentPaginatedList, SDKError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;

...
export declare class Shipments extends ClientSDK {
     ...
     */
    list(request: operations.ListShipmentsRequest, options?: RequestOptions): Promise<components.ShipmentPaginatedList>;
    /**
     ...
     */
    create(request: components.ShipmentCreateRequest, options?: RequestOptions): Promise<components.Shipment>;
    /**
     * Retrieve a shipment
     *
     * @remarks
     ...
     */
    get(shipmentId: string, options?: RequestOptions): Promise<components.Shipment>;
}

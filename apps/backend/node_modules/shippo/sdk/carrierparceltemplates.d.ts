...
export declare class CarrierParcelTemplates extends ClientSDK {
     ...
     * </ul>
     */
    list(include?: operations.Include | undefined, carrier?: string | undefined, options?: RequestOptions): Promise<components.CarrierParcelTemplateList>;
    /**
     ...
     */
    get(carrierParcelTemplateToken: string, options?: RequestOptions): Promise<components.CarrierParcelTemplate>;
}

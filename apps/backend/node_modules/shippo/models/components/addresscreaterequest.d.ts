...
/** @internal */
export declare const AddressCreateRequest$inboundSchema: z.ZodType<AddressCreateRequest, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const AddressCreateRequest$outboundSchema: z.ZodType<AddressCreateRequest$Outbound, z.ZodTypeDef, AddressCreateRequest>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace AddressCreateRequest$ {
    /** @deprecated use `AddressCreateRequest$inboundSchema` instead. */
    const inboundSchema: z.ZodType<AddressCreateRequest, z.ZodTypeDef, unknown>;
    /** @deprecated use `AddressCreateRequest$outboundSchema` instead. */
    const outboundSchema: z.ZodType<AddressCreateRequest$Outbound, z.ZodTypeDef, AddressCreateRequest>;
    /** @deprecated use `AddressCreateRequest$Outbound` instead. */
    type Outbound = AddressCreateRequest$Outbound;
}
export declare function addressCreateRequestToJSON(addressCreateRequest: AddressCreateRequest): string;
export declare function addressCreateRequestFromJSON(jsonString: string): SafeParseResult<AddressCreateRequest, SDKValidationError>;
//# sourceMappingURL=addresscreaterequest.d.ts.map
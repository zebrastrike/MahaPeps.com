...
/** @internal */
export declare const CustomsItemCreateRequest$inboundSchema: z.ZodType<CustomsItemCreateRequest, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const CustomsItemCreateRequest$outboundSchema: z.ZodType<CustomsItemCreateRequest$Outbound, z.ZodTypeDef, CustomsItemCreateRequest>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace CustomsItemCreateRequest$ {
    /** @deprecated use `CustomsItemCreateRequest$inboundSchema` instead. */
    const inboundSchema: z.ZodType<CustomsItemCreateRequest, z.ZodTypeDef, unknown>;
    /** @deprecated use `CustomsItemCreateRequest$outboundSchema` instead. */
    const outboundSchema: z.ZodType<CustomsItemCreateRequest$Outbound, z.ZodTypeDef, CustomsItemCreateRequest>;
    /** @deprecated use `CustomsItemCreateRequest$Outbound` instead. */
    type Outbound = CustomsItemCreateRequest$Outbound;
}
export declare function customsItemCreateRequestToJSON(customsItemCreateRequest: CustomsItemCreateRequest): string;
export declare function customsItemCreateRequestFromJSON(jsonString: string): SafeParseResult<CustomsItemCreateRequest, SDKValidationError>;

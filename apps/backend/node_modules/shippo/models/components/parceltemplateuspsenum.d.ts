 ...
 */
export declare const ParcelTemplateUSPSEnum: {
    ...
    readonly USPSIrregularParcel: "USPS_IrregularParcel";
    readonly USPSLargeFlatRateBoardGameBox: "USPS_LargeFlatRateBoardGameBox";
    readonly USPSLargeFlatRateBox: "USPS_LargeFlatRateBox";
    readonly USPSAPOFlatRateBox: "USPS_APOFlatRateBox";
    readonly USPSLargeVideoFlatRateBox: "USPS_LargeVideoFlatRateBox";
    ...
    readonly USPSSoftPack: "USPS_SoftPack";
};
/**
 * |Token | Name | Dimensions|
 *
...
/** @internal */
export declare const ParcelTemplateUSPSEnum$inboundSchema: z.ZodNativeEnum<typeof ParcelTemplateUSPSEnum>;
/** @internal */
export declare const ParcelTemplateUSPSEnum$outboundSchema: z.ZodNativeEnum<typeof ParcelTemplateUSPSEnum>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace ParcelTemplateUSPSEnum$ {
...
//# sourceMappingURL=parceltemplateuspsenum.d.ts.map
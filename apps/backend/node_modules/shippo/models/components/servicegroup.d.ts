...
/** @internal */
export declare const ServiceGroup$inboundSchema: z.ZodType<ServiceGroup, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const ServiceGroup$outboundSchema: z.ZodType<ServiceGroup$Outbound, z.ZodTypeDef, ServiceGroup>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace ServiceGroup$ {
    /** @deprecated use `ServiceGroup$inboundSchema` instead. */
    const inboundSchema: z.ZodType<ServiceGroup, z.ZodTypeDef, unknown>;
    /** @deprecated use `ServiceGroup$outboundSchema` instead. */
    const outboundSchema: z.ZodType<ServiceGroup$Outbound, z.ZodTypeDef, ServiceGroup>;
    /** @deprecated use `ServiceGroup$Outbound` instead. */
    type Outbound = ServiceGroup$Outbound;
}
export declare function serviceGroupToJSON(serviceGroup: ServiceGroup): string;
export declare function serviceGroupFromJSON(jsonString: string): SafeParseResult<ServiceGroup, SDKValidationError>;

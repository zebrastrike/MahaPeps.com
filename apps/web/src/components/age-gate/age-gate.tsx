    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-charcoal-900/95 backdrop-blur-sm p-4 sm:p-6 overflow-y-auto">
      <div className="w-full max-w-2xl rounded-xl border-2 border-red-500 bg-charcoal-800 p-4 sm:p-8 shadow-2xl my-4 sm:my-8">
        ...
        <div className="mb-6 text-center">
          ...
          <h1 className="text-xl font-bold text-clinical-white sm:text-2xl">Legal Agreement Required</h1>
          <p className="text-xs text-charcoal-400 sm:text-sm mt-2">You must read and accept all terms before accessing this website</p>
        </div>
        ...
        <div className="space-y-3 sm:space-y-4 mb-6">
          ...
          <label className="flex cursor-pointer items-start gap-3 rounded-lg border-2 border-charcoal-600 bg-charcoal-900/50 p-3 sm:p-4 hover:border-accent-500 transition-colors">
            <input
              ...
              className="mt-0.5 h-4 w-4 rounded border-charcoal-600 bg-charcoal-900 text-accent-500 focus:ring-2 focus:ring-accent-500/20 flex-shrink-0 sm:h-5 sm:w-5"
            />
            <div className="text-xs text-charcoal-200 sm:text-sm">
